...
<div class="container-fluid px-0">
    ...
    <div class="container-fluid become-banner">
        <center><h1>Membership Registration</h1></center>
    </div>
    <div class="container-fluid become-body1">
        <div class="container">
            <div class="mem-form-cont">
                <h5>Note: You are required to make payment of #50,000.00 to complete your registration. Kindly fill in your details and
                    proceed to payment</h5>
                <div class="mem-input-cont">
                    <form action="">
                        ...
                        <div class="mem-amount">
                            <p>Amount (NGN)</p>
                            <input type="number" name="amount" value="50000" readonly>
                        </div>
                        <div class="mem-phone">
                            <p>Phone Number</p>
                            <input type="tel" name="phone-num" placeholder="Enter your phone number">
                        </div>
                    </form>
